...
const DISHES = [
  { id:1, name:'Hyderabadi Dum Biryani',  chef:'Chef Fatima Begum',      price:220, rating:4.9, reviews:842,  time:'40 min', cat:'Biryani',      image:'/assets/hyderabadi_biryani.png', tag:'Best Seller', tagStyle:'badge-orange', spicy:true },
